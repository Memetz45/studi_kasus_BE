...
const index = async (req, res, next) => {
    try{
        let {skip = 0, limit = 10, q = '', category = '', tags = []} = req.query; // inisiasi skip dan limit untuk custom nilai limit dengan contoh default skip 0 dan limit 10
        // error pada materi filter, limit, dan count lihat error pada screenshoot
        let criteria = {};
